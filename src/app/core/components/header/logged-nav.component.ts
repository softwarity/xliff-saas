...
@Component({
  ...
  `],
  template: `
    <a routerLink="/dashboard" routerLinkActive="!text-primary dark:!text-blue-400" class="tab-button">
    ...
    <a routerLink="/git-providers" routerLinkActive="!text-primary dark:!text-blue-400" class="tab-button">
    ...
    @for (provider of getConnectedProviders(); track provider.type) {
      <a [routerLink]="['/repositories', provider.type]" routerLinkActive="!text-primary dark:!text-blue-400" class="tab-button">
